...
python /home/cz/bs/rt_torch/train.py --alias fusion-single --device_idx 7 --model fusion  --train-iters 500000 --test-iters 100 --test-interval 2500 --save-interval 2500 --scheduler cosine --loader_bs 1 --eval-eps 10 --eval-timeout 100 --lr_t 1 --lr_eff 1 --lr 1e-4 --min_lr 1e-5 --heads 4 --model_dim 256 --batch_size 96
python /home/cz/bs/rt_torch/train.py --alias fusion-single --device_idx 6 --model fusion  --train-iters 500000 --test-iters 100 --test-interval 2500 --save-interval 2500 --scheduler cosine --loader_bs 1 --eval-eps 10 --eval-timeout 100 --lr_t 1 --lr_eff 1 --lr 1e-3 --min_lr 1e-4 --heads 4 --model_dim 256 --batch_size 96
python /home/cz/bs/rt_torch/train.py --alias fusion-single --device_idx 5 --model fusion  --train-iters 500000 --test-iters 100 --test-interval 2500 --save-interval 2500 --scheduler cosine --loader_bs 1 --eval-eps 10 --eval-timeout 100 --lr_t 1 --lr_eff 1 --lr 1e-5 --min_lr 1e-6 --heads 4 --model_dim 256 --batch_size 96